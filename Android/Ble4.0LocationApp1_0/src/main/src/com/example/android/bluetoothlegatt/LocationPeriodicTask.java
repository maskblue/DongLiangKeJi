		...
		if (!isStarted) {
			...
			timer.scheduleAtFixedRate(new TimerTask() {
				...
				public void run() {
					...
					{
						if(calcRelativePosition(locationData.dev_last_radius, locationData.dev_last_theta, (step - locationData.step_distance_count) * 1.02,  Orientation.get_pose()[0] + 0.0, position_info))
						{
