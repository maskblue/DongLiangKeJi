...
public class DeviceControlActivity extends Activity {
    ...
    public static final String EXTRAS_DEVICE_NAME = "DEVICE_NAME";    //得到rssi好像是可以再这里得到
           ...
           // 自加读取rssi值得部分，ACTION_FOUND
            if(BluetoothDevice.ACTION_FOUND.equals(action))
            {
            	...
            	if(device.getBondState() != BluetoothDevice.BOND_BONDED)
            	{
            		...
            		Log.e("pppppppppppppppppppppppppppppppppppppp", "rssiAver = :"+rssi);
            	}
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDeviceName = intent.getStringExtra(EXTRAS_DEVICE_NAME);		//在这里
